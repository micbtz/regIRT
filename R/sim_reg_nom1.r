...
sim_reg_nom1<-function(r,n,param0,D,lambda,itmsel,cat0,pen,adaptive)
{
  ...
  if (allcat)
  {
    ...
    # cross-validation
    cvres<-nominalCV(data=dataset,D=D,K=5,parini=par_lasso1,parW=par_lasso1,lambda=lambda,pen=pen,adaptive=adaptive)
  }
